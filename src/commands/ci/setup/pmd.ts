...
const messages = Messages.loadMessages('sfdx-plugin-ci', 'pmd');

const templateFolder = path.resolve(__dirname, '../../../../template/ci/setup/pmd/');
const templateFile = 'apex-ruleset.xml';
