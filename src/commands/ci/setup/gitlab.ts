...
const messages = Messages.loadMessages('sfdx-plugin-ci', 'gitlab');

const templateFolder = path.resolve(__dirname, '../../../../template/ci/setup/gitlab/');
const templateFile = '.gitlab-ci.yml';

export default class Gitlab extends SfdxCommand {
